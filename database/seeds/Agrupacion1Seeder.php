...
{    /**
	...
	public function run()
	{
		   ...
		   DB::table('cat_agrupacion1')->insert([
				...
				['nombre' => 'A BANCO','idCatDelito'=> 9],
				['nombre' => 'A CAMION REPARTIDOR', 'idCatDelito' => 9],
				['nombre' => 'A CASA HABITACION', 'idCatDelito' => 9],
				['nombre' => 'A NEGOCIACIONES', 'idCatDelito' => 9],
				['nombre' => 'A TRANSEUNTE', 'idCatDelito' => 9],
				['nombre' => 'A TRANSEUNTES', 'idCatDelito' => 9], 
				['nombre' => 'DE FRUTOS', 'idCatDelito' => 9], 
				['nombre' => 'DE VEHICULO', 'idCatDelito' => 9],
				['nombre' => 'EN GRADO DE TENTATIVA', 'idCatDelito' =>9],
				...
				['nombre' => 'DE MAQUINARIA', 'idCatDelito' =>9], 
				['nombre' => 'DE VEHICULO AUTOMOTOR', 'idCatDelito' => 9],
				['nombre' => 'DE TRANSPORTISTAS', 'idCatDelito' => 9],  
				['nombre' => 'DE AUTOPARTES', 'idCatDelito' =>9],
				//52
