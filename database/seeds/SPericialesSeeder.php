...
class SPericialesSeeder extends Seeder
{
    ...
    public function run()
    {
 	    DB::table('cat_spericiales')->insert([
			...
			['id'=> 19,	'nombre' => 'RECONOCIMIENTO DE LEY (NECROPSIA)'],
			...
			['id'=> 43,	'nombre' => 'VALUACIONES ARQUITECTÓNICOS'],
			...
			['id'=> 73,	'nombre' => 'UBICACION DE TESTIGOS Y DATOS PARA ESTABLECER EL HECHO DELICTIVO'],
