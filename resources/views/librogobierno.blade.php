				...
				<div class="col-5" align="center" >
					<div class="form-group">
						...
						<div class="input-group date" id="fechaLibroFin" data-target-input="nearest">
							{!! Form::text('fechaLibroFin', null, ['class' => 'form-control form-control-sm datetimepicker-input', 'data-target' => '#fechaLibroFin', 'data-toggle' => 'datetimepicker', 'required', 'placeholder' => 'DD/MM/AAAA']) !!}
...
<script type="text/javascript">
    ...
    $('#consultar').on('click',function(e){
        ...
        var fechaIni=$("#fechaLibroIni").val();
        var fechaFin=$("#fechaLibroFin").val();
