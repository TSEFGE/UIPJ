        ...
        <div class="boxtwo">
            ...
            <div class="text-right">
                @if(count($acusaciones)>0)
                    <a href="{{ route('new.colaboracionpm', $carpetaNueva[0]->id) }}" class="btn btn-secondary">Diligencia a PM</a>
                    <a href="{{ route('new.colaboracionsp', $carpetaNueva[0]->id) }}" class="btn btn-secondary">Diligencia a SP</a>
                @endif
