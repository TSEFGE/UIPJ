<div class="row">
	...
	<div class="col-3">
		<div class="form-group">
			...
			{!! Form::text('segundoAp', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el segundo apellido','data-validation'=>'custom' ,'data-validation-regexp'=>'^(([A-ZÁÉÑÍÓÚ][\s]*)?){1,50}$','data-validation-error-msg'=>'Segundo apellido debe contener solo letras','data-validation-event'=>'keyup']) !!}
	...
	<div class="col-3">
		<div class="form-group">
			...
			{!! Form::select('sexo', ['SIN INFORMACIÓN' => 'SIN INFORMACIÓN', 'HOMBRE' => 'HOMBRE', 'MUJER' => 'MUJER'], null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Seleccione el sexo', 'data-validation'=>'required' ,'data-validation-event'=>'change']) !!}
		</div>
	</div>
	<div class="col-3">
		<div class="form-group">
	...
	<div class="col-3">	
		<div class="row no-gutters">
			<div class="col-7">
				...
				{!! Form::text('rfc', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el R.F.C.', 'required','data-validation'=>'custom' ,'data-validation-regexp'=>'^([A-Z,Ñ,&]{4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))$','data-validation-error-msg'=>'RFC inválido','data-validation-event'=>'keyup']) !!}
					<input type="hidden" name="rfcAux" id="rfcAux">
			</div>

			<div class="col-5">
				{!! Form::label('homo', 'Homoclave', ['class' => 'col-form-label-sm']) !!}
				{!! Form::text('homo', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Homoclave', 'required','data-validation'=>'custom' ,'data-validation-regexp'=>'^([A-Z\d]{2}([A\d]))$','data-validation-error-msg'=>'Homoclave inválida','data-validation-event'=>'keyup']) !!}
	...
	<div class="col-3">
		<div class="form-group">
			...
			{!! Form::text('telefono', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el teléfono', 'data-validation'=>'custom', 'data-validation-regexp'=>'^([0-9]{10,15}|(SIN NUMERO))$','data-validation-error-msg'=>'Teléfono debe contener de diez a quince números o SIN NUMERO','data-validation-event'=>'keyup']) !!}
		</div>
	</div>
</div>
