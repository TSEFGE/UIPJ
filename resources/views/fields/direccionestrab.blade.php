<div class="row">
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::select('idMunicipio2',$municipiosVer, null,['placeholder' => 'Seleccione un municipio','class' => 'form-control form-control-sm', 'required']) !!}
		</div>
	</div>
	<div class="col-4">
		<div class="form-group">
	...
	<div class="col-4">
		<div class="form-group">
			...
			<div class="invalid-feedback" id="invalidCalle2">
