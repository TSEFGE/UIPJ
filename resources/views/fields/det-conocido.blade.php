<div class="row">
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::text('nombresC', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el nombre','data-validation'=>'custom' ,'data-validation-regexp'=>'^([A-ZÁÉÑÍÓÚ][\s]*){1,100}$']) !!}	
		</div>
	</div>
	<div class="col-4">
		<div class="form-group">
