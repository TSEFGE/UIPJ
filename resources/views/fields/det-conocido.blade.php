<div class="row">
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::text('aliasC', "SIN INFORMACION", ['class' => 'form-control form-control-sm']) !!}
...
<div class="row">
	<div class="col-12">
		<div class="form-group">
			...
			{!! Form::textarea('senasParticC',"SIN INFORMACION", ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese las señas particulares','rows' => '3']) !!}
