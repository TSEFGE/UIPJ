<div class="row">
	<div class="col-8">
		<div class="form-group">
			...
			{!! Form::text('lugarTrabajo', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el lugar de trabajo','data-validation'=>'length', 'data-validation-length'=>'5-50','data-validation-error-msg'=>'Lugar de trabajo debe contener al menos cinco letras', 'data-validation-event'=>'keyup']) !!}
		</div>
	</div>
	<div class="col-4">
		<div class="form-group">
