...
class ColaboracionController extends Controller
{
    ...
    {
        Alert::info('Para generar el documento debes seleccionar los servicios solicitados seguido de la acusación que se encuentra en la lista de abajo. ', 'Importante')->persistent("Aceptar");
