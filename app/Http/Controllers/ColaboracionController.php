...
class ColaboracionController extends Controller
{
    ...
    public function showForm2($idCarpeta)
    {
        ...
        $diligenciasSP = DB::table('diligencias_sp')
            ...
            ->select('per.nombres as nombresADO', 'persona.nombres as nombresTE', 'cat_delito.nombre as delito', 'diligencias_sp.dictamen', 'diligencias_sp.status', 'diligencias_sp.oficio', 'diligencias_sp.created_At as fecha')
