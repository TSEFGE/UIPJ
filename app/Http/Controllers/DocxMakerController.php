...
class DocxMakerController extends Controller
{
    ...
    public function getConstanciaHechos($idDenunciante)
    {
        $info = DB::table('extra_denunciante')
            ...
            ->select('persona.nombres as nombresD', 'persona.primerAp as primerApD', 'persona.segundoAp as segundoApD', 'carpeta.id', 'carpeta.numCarpeta', 'carpeta.fechaInicio', 'unidad.direccion', 'unidad.telefono', 'unidad.idDistrito', 'unidad.municipio', 'users.nombres', 'users.apellidos', 'users.numFiscal')
    ...
    public static function getFormatoDenuncia($idAcusacion)
    {
        $carpeta = DB::table('acusacion')
            ...
            ->select('carpeta.numCarpeta', 'carpeta.fechaInicio', 'carpeta.conDetenido', 'users.nombres', 'users.apellidos', 'users.numFiscal', 'unidad.direccion', 'unidad.telefono', 'unidad.idDistrito', 'unidad.municipio')
        ...
        $distritoLetra   = DocxMakerController::getDistritoLetra($carpeta->idDistrito);
